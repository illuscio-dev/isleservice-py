...
def alter_service_name_var(target_name: str) -> None:
    """
    Rewrites ._name.py
    :param target_name: new name of library
    """

    name_file = pathlib.Path("./service/_name.py").absolute()
    name_file.write_text(f'SERVICE_NAME: str = "{target_name}"\n')
...
def alter_new(script_info: ScriptInfo) -> None:
    ...
    # alter service name file
    alter_service_name_var(script_info.name_target)
